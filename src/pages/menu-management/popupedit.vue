...
<template>
    <div
        class="editwrapper hidden items backdrop-blur-[0px] justify-end pr-0 h-screen w-screen font-sora select-none sm:pr-5">
        <div @click="ClosePopup" class=" fixed h-screen w-screen flex-grow hidden sm:block"></div>
        <div class="py-10 hidden sm:flex">
            <div class="edit shadow-2xl flex flex-col w-[500px] bg-white opacity-0 rounded-[30px] overflow-hidden">
                <!-- TOP ------------------------------------------------>
