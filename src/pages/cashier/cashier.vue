<script setup>
import { ref } from 'vue'
import menu_drinks from './menu_drinks.vue'
</script>

<template>
    <div class="px-5 relative md:px-[43px] grid grid-cols-[2fr,1fr] font-sora select-none"
        style="top: 80px; height: calc(100vh - 80px);">
        <div class="flex flex-col overflow-hidden">
            <div class="h-[180px] flex gap-2">
                ...
                <div class="w-1/2 flex flex-col justify-evenly">
                    ...
                    <div class="flex flex-row whitespace-nowrap gap-5 overflow-x-scroll overflow-y-hidden">
                        <div class="p-3 w-[256px] h-[99px] bg-secondary rounded-[15px] text-accent">
                            <p class="text-[24px] font-bold">Customer Name</p>
                            <p class="text-[16px] font-light">Order#102313</p>
                            <p class="text-[12px] font-light">Item/s: 2X</p>
                        </div>
        ...
        <!-- basket -->
        <div class="border-2 mb-1 flex flex-col rounded-xl overflow-hidden">
            <!-- TOP ------------------------------------------------>
            <div class="flex items-center justify-between border-b-2 px-5 py-5">
                <span>
                    <h1 class="font-bold text-[24px] flex items-center gap-2">Customer Name
                ...
                <Button label="Primary" @click="animateBasket" class="flex flex-col bg-transparent">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="darkgrey" class="w-[24px] h-[24px]">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="m14.74 9-.346 9m-4.788 0L9.26 9m9.968-3.21c.342.052.682.107 1.022.166m-1.022-.165L18.16 19.673a2.25 2.25 0 0 1-2.244 2.077H8.084a2.25 2.25 0 0 1-2.244-2.077L4.772 5.79m14.456 0a48.108 48.108 0 0 0-3.478-.397m-12 .562c.34-.059.68-.114 1.022-.165m0 0a48.11 48.11 0 0 1 3.478-.397m7.5 0v-.916c0-1.18-.91-2.164-2.09-2.201a51.964 51.964 0 0 0-3.32 0c-1.18.037-2.09 1.022-2.09 2.201v.916m7.5 0a48.667 48.667 0 0 0-7.5 0" />
                    </svg>
                    <p class="text-darkgrey text-[14px]">clear</p>
                </Button>
            </div>
            <!-- MIDDLE ------------------------------------------------>
            <div class="px-5 font-bold text-[20px] border-b-2 py-3 h-3/5 overflow-hidden">
                <span class="flex cursor-pointer">2 items</span>
                ...
                <div class="pt-2 flex flex-col h-[70%] space-y-2 overflow-y-auto">
                    ...
                    <div class="grid grid-cols-3 text-[16px] font-normal">
                        ...
                        <div class="flex justify-between items-center pl-[60px]">
                            <p>₱</p>
                            <p>100.00</p>
                        </div>
                    </div>
            ...
            <div class="px-5 my-5 space-y-5">
                <div class="flex justify-between items-center">
                    ...
                    <span class="relative w-20">
                        <InputText size="small" v-model="value1" placeholder="₱" />
                    </span>
                </div>
