  ...
  accordiontab: {
    ...
    headerAction: ({ context }) => ({
      class: [
        ...
        "rounded-t-md",
        {
          "border-b-3px rounded-br-md rounded-bl-md": !context.active,
          "border-b-0 rounded-br-0 rounded-bl-0": context.active,
        },

        // Color
        "border-[3px] border-offwhite dark:border-surface-700",
