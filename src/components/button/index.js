export default {
  root: ({ props, context, parent }) => ({
    class: [
      ...
      "leading-[normal]",
      {
        "px-3 py-3": props.size === null,
        "text-sm py-1 px-3": props.size === "small",
        "text-xl py-1 px-4": props.size === "large",
      },
      {
        "w-12 p-0 py-1": props.label == null && props.icon !== null,
      },

      // Shapes
      { "shadow-lg": props.raised },
      { "rounded-xl": !props.rounded, "rounded-full": props.rounded },
      {
      ...
      // Primary Button
      {
        "text-white dark:text-surface-900":
          ...
          !props.outlined &&
          !props.plain,
        "bg-offwhite dark:bg-primary-400":
          !props.link &&
          props.severity === null &&
          !props.text &&
          !props.outlined &&
